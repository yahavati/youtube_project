  ...
  const handleSubmit = (e) => {
    ...
    if (isValid) {
      ...
      setTimeout(() => {
        ...
        // Redirect to main screen or perform any other action
        window.location.href = '/main'; // Replace with your main screen path
      ...
      <div className="form-wrapper">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="input-wrapper">
            ...
            {validationMessages.confirmPassword && (
              <div className={`error-message ${validationMessages.confirmPassword === 'Passwords match' ? 'success-message' : ''}`}>
                {validationMessages.confirmPassword}
              </div>
            )}
          </div>
          ...
          <div className="validation-container">
            <p className="validation-message">Username must be at least 5 characters long and include at least one number.</p>
            <p className="validation-message">Password must be at least 8 characters long and contain both letters and numbers.</p>
          </div>
          <button type="button" className="button" onClick={() => setIsCameraOpen(true)}>Open Camera</button>
        ...
        {isRegistered && (
          <div className="success-message">
            Registration successful! Redirecting to the main screen...
          </div>
        )}
      </div>
    </div>
