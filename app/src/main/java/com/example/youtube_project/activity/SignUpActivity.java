        ...
        new Thread(() -> {
            try {
                ...
                RequestBody requestBody = new MultipartBody.Builder()
                        ...
                        .addFormDataPart("profilePhotoUrl", imageFile.getName(),
                                RequestBody.create(MediaType.parse("image/*"), imageFile))
                        .build();

                Response response = ApiHandler.sendMultipartPost("/register", requestBody);
                ...
                if (response.isSuccessful()) {
                    ...
                    if (success) {
                        ...
                        runOnUiThread(() -> Toast.makeText(SignUpActivity.this, errorMsg, Toast.LENGTH_SHORT).show());
                    }
                } else {
                    runOnUiThread(() -> Toast.makeText(SignUpActivity.this, "Error: Unable to connect to the server.", Toast.LENGTH_SHORT).show());
                }
            } catch (IOException e) {
                e.printStackTrace();
